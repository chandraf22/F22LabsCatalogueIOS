...
//    func makeTheCellAtIndexpathFocused(indexPath:IndexPath) {
//        let attributeForNewCellinFocus = layoutAttributesForItem(at: indexPath)
//        let focusCenter = getFocusCenter()
//        if let currentCellCenter = attributeForNewCellinFocus?.center.x {
//            
//            let diff = currentCellCenter - focusCenter
//            let currentContentOffset = collectionView?.contentOffset
//            let newContentOffset = CGPoint(x: (currentContentOffset?.x)! + diff, y: (currentContentOffset?.y)!)
